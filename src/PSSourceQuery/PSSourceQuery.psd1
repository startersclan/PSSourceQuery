#
# Module manifest for module 'PSGet_PSSourceQuery'
#
# Generated by: Starters Clan
#
# Generated on: 5/30/21
#
...
FunctionsToExport = 'GoldSourceRcon', 'SourceQuery', 'SourceRcon'
...
PrivateData = @{
    ...
    PSData = @{
        ...
        Tags = 'goldsource-dedicated-server','goldsource','hlds','library','powershell','pwsh','query','rcon','source-dedicated-server','source','sourcequery','srcds','steam','steam-games','steam','valve'
